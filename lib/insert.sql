INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "The Dance of Dragons", 1, 1), (2, "Fith Series", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "War"), (2, "War Horse");
...
INSERT INTO characters (id, name, motto, species, author_id) VALUES (1, "Arya Stark", "I will kill all them", "wolf", 1), (2, "Tyrion Lanister", "A Lanister always pays it's debts", "human", 1), (3, "Daenerys Targaryen", "I'm the reason why you still alive", "human", 1), (4, "Edcv Stark", "Winter is coming", "human", 1);
